...
def serializedATN():
    return [
        ...
        23,1,0,0,0,11,12,5,100,0,0,12,2,1,0,0,0,13,14,5,43,0,0,14,4,1,0,
        0,0,15,16,5,45,0,0,16,6,1,0,0,0,17,19,7,0,0,0,18,17,1,0,0,0,19,20,
...
class RollLexer(Lexer):
    ...
    ruleNames = [ "T__0", "T__1", "T__2", "NUMBER", "WHITESPACE" ]
